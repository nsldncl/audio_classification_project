...
#base path for dataset audio files
basepath = ''
...
def create_dataset():
    ...
    dev_csv = load_csv_file('clotho_captions_development.csv')
    val_csv = load_csv_file('clotho_captions_validation.csv')
    eval_csv = load_csv_file('clotho_captions_evaluation.csv')
    ...
    words_list = load_picke_file('new_words_list.p')
